...
- **Energy Blades** - Powerful melee weapons in multiple colors (blue, green, red, yellow, purple) with custom swing sounds and fast obsidian mining
- **Prismatic Energy Blade** - Ultimate blade that cycles through all colors
- **Energy Boomerang** - Throwable weapon that curves through the air, pierces multiple enemies, and returns to the player
